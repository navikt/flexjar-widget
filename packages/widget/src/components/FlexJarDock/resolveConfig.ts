...
export function resolveConfig(
    ...
    return {
        ...
        submitPendingLabel: labels?.submitPending ?? DEFAULT_COPY.submitPendingLabel,
        cancelLabel: labels?.cancel ?? DEFAULT_COPY.cancelLabel,
        validationErrorMessage: labels?.validationError ?? DEFAULT_COPY.validationErrorMessage,
        transportErrorMessage: labels?.transportError ?? DEFAULT_COPY.transportErrorMessage,
        ...
        successPrimaryLabel: success?.primaryLabel ?? DEFAULT_COPY.successPrimaryLabel,
