...
describe("evaluateVisibility", () => {
    ...
    describe("with CONTAINS operator", () => {
        it("returns true when array contains value", () => {
            ...
            expect(evaluateVisibility(condition, { tasks: ["apply", "check"] })).toBe(true);
        });
        ...
        it("returns false when array does not contain value", () => {
            ...
            expect(evaluateVisibility(condition, { tasks: ["check", "status"] })).toBe(false);
        });
    });
    ...
    describe("with METADATA field", () => {
        it("evaluates metadata conditions", () => {
            ...
            expect(evaluateVisibility(condition, {}, { userType: "employee" })).toBe(true);
            expect(evaluateVisibility(condition, {}, { userType: "employer" })).toBe(false);
        });
    });
});
