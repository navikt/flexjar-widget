...
export interface UseAnswerStateOptions {
  ...
  onAnswer?: (questionId: string, value: FlexJarAnswerValue | null | undefined) => void;
}
...
export function useAnswerState(options: UseAnswerStateOptions): UseAnswerStateReturn {
...
function shouldDropValue(value: FlexJarAnswerValue | null | undefined): boolean {
